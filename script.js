...
const SEARCHES = [
  "Dlaczego oni tak obrazaja tego papieza?",
  "Ile dzieci zgwalcono w kosciolach?",
  "Jan Pawel 2 rule34",
  "Czy Jan Pawel 2 mial stulejke?",
  "Czy Jan Pawel 2 byl pedofilem?",
  "Czy Jan Pawel 2 gwalcil tez chlopakow?",
  "Bialy klej z siusiaka na widok Jana Pawla 2 - czy to normalne?",
  "Archiwa Watykanu - nagie dzieci z Janem Pawlem 2",
  "Przyrodzenie Jana Pawla 2",
  "Metody Jana Pawla 2 na powiekszenie penisa",
  "Dlaczego Jan Pawel 2 nie mial wlasnych dzieci?",
  "ofiary gwaltu przez Jana Pawla 2",
  "Jan Pawel 2 - pedofil z Watykanu",
  "Jan Pawel 2 nawiedza mnie w nocy",
];

const VIDEOS = [
  "./assets/PAPIEZ_ZAWADIAKA.mp4",
  "./assets/jp2_jest_bogiem.mp4",
  "hehe_papaj_tanczy.mp4",
];
